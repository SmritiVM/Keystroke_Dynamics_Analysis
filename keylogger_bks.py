...
def generate_timing_vector(keystroke_timings, password, backspaces, current_iteration):
...
if __name__ == "__main__":
    ...
    while current_iteration <= 2:
        ...
        if data_entered == password:
            ...
            timing_vector = generate_timing_vector(keystroke_timings, password, backspaces, current_iteration)
